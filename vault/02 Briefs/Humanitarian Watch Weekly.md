...
- The UNHCR/OCHA channel's current published year (**2025**) records a global forcibly
  ...
  — the source's own category totals, held flat across every pull absorbed this week
  (2026-08-17 through 08-20, 2026-W34) and unchanged from the entire 2026-08-07 → 08-16 window
  absorbed the prior cycle (2026-W33), reported as published ([[displacement-flows]]).
- The dataset still carries per-country figures for **212 countries/territories**. By
  **internally displaced population**, the six largest recorded stocks on the 2026-08-20 pull
  ...
  the prior cycle and every pull absorbed this week, figures as the source publishes them
  ([[displacement-flows]]).
...
- Week-on-week: the 2026-08-17 through 2026-08-20 pulls — every day absorbed so far in W34 —
  are **byte-identical** across the full payload — global aggregates, all 212 country rows and
  both rankings above moved by zero (the pulls differ only in the `retrieved`/`fetchedAt`
  timestamp). The prior cycle (2026-08-07 through 08-16, W33) was itself fully flat, so there
  is no evidence of a revision across the W33 → W34 boundary or on any day of W34 absorbed so
  far — a fully flat run, reported honestly rather than manufactured ([[displacement-flows]]).
...
- 2026-07-15 — first Humanitarian Watch Weekly cycle (2026-W29): theme un-held (the hold was
  ...
  ([[displacement-flows]]).
- 2026-08-20 — daily-ingest synthesis (2026-W34): absorbed the 2026-08-18 through 08-20 pulls — byte-identical to 08-17 across the full payload (106,175,975 total forcibly displaced: 64,239,352 IDPs / 28,461,306 refugees / 8,998,097 asylum / 4,477,220 stateless; 212 countries; per-country IDP and refugee rankings unchanged, Sudan IDP 9,139,309 / Ukraine refugees 5,224,131 lead). No source revision recorded; the flat run first recorded 2026-07-16 now spans 35 days through 08-20. `week`/`updated` and pull timestamp advanced to the 08-20 ingest. Observed-only, no-position framing held ([[displacement-flows]]).
