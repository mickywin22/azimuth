...
> links to the L1 note it rests on.
...
- The UNHCR/OCHA channel's current published year (**2025**) records a global forcibly
  ...
  — the source's own category totals, reported as published ([[displacement-flows]]).
- The dataset carries per-country figures for **212 countries/territories**. The largest
...
- The 2026-07-16 and 2026-07-17 pulls returned **identical figures** to the 2026-07-15
  baseline — no revision to the 2025 reference-year totals was recorded across those two
  cycles ([[displacement-flows]]).
...
- The 07-16 and 07-17 ingest cycles each confirmed the same totals (106,175,975 total /
...
- Two of every three forcibly displaced people in the 2025 published year are displaced
  *within* their own country — the 64,239,352 IDP figure dwarfs the cross-border refugee
  ...
  ([[displacement-flows]]).
- The ten highest-displacement countries by total count (IDPs + refugees + asylum seekers)
  in the 2025 dataset are: Sudan (12,900,343), Syrian Arab Rep. (10,562,346), Ukraine
  (8,962,714), Colombia (7,540,658), Dem. Rep. of the Congo (7,014,389), Afghanistan
  (6,140,590), Myanmar (5,221,042), Yemen (4,879,170), Somalia (4,475,716) and Ethiopia —
  figures as the source publishes them ([[displacement-flows]]).
