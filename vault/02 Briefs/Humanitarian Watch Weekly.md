...
- The UNHCR/OCHA channel's current published year (**2025**) records a global forcibly
  ...
  — the source's own category totals, held flat from prior cycles, reported as published
  ([[displacement-flows]]).
- The dataset carries per-country figures for **212 countries/territories**. The six largest
  displacement situations by combined stock (refugees + IDPs + asylum seekers), as recorded
  in the 2026-07-23 pull, are: **Sudan** (refugees 2,820,737 / IDPs 9,139,309 / host-asylum
  940,297), **Syria** (refugees 4,865,764 / IDPs 5,542,227 / asylum-seekers 154,355),
  **Ukraine** (refugees 5,224,131 / IDPs 3,712,000 / asylum-seekers 26,583), **Afghanistan**
...
- Two of every three forcibly displaced people in the 2025 published year are displaced
  *within* their own country — the 64,239,352 IDP figure dwarfs the cross-border refugee
  ...
  ([[displacement-flows]]).
- The 2026-07-23 pull surfaces the per-country IDP stocks in sharper detail. **Sudan**
  records the largest single IDP population in the set at **9,139,309** — ahead of Syria's
  5,542,227 and Myanmar's 3,628,840. **Ukraine** carries the largest refugee stock at
  **5,224,131**, followed by Syria at 4,865,764 and Sudan at 2,820,737. **Afghanistan**
