...
- **Supply side:** US crude stocks tightened — -10,964 week of 2026-07-24. A draw normally argues for FIRMER prices ([[crude-oil-inventories]])
- **Price side:** WTI $88.58/bbl rose (+9.7 reported w/w) — the actual tape, against what the inventory draw implied ([[energy-prices]])
...
- **Largest recorded event:** M6.8 2026 Uto, Japan Earthquake — one of 66 events at or above M5 USGS logged this week ([[earthquakes]])
...
- **Commodity spine — crude oil ties three feeds together:** the physical balance (-10,964 EIA stocks, 2026-07-24); the spot price (WTI $88.58/bbl); the pump (downstream fuel-price panel). One commodity, traced from the ground to the pump across separate L1 feeds ([[crude-oil-inventories]], [[energy-prices]], [[fuel-prices]])
