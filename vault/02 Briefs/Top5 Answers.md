...
- **EU gas storage is building** — 2,983 Bcf as of 2026-07-03, +61 Bcf week-on-week, extending the injection run to 8 straight weeks ([[natural-gas-storage-eu]])
- **US crude inventories drew down** -3,168 (EIA week of 2026-07-03) to 730,846 — the 8th straight weekly draw, the one tightening signal in the picture ([[crude-oil-inventories]])
- **Spot crude eased** this week — WTI $70.48/bbl (-4.2), Brent $69.7/bbl (-5.3) on the reported week-on-week change, so the price tape is not signalling scarcity ([[energy-prices]])
...
- **Supply side:** US crude stocks tightened — -3,168 week of 2026-07-03. A draw normally argues for FIRMER prices ([[crude-oil-inventories]])
- **Price side:** WTI $70.48/bbl fell (-4.2 reported w/w) — the actual tape, against what the inventory draw implied ([[energy-prices]])
...
- **Largest recorded event:** M5.8 91 km SSW of Isangel, Vanuatu — one of 38 events at or above M5 USGS logged this week ([[earthquakes]])
...
- **Biggest move: Brent Crude Oil, -7.1% week-on-week** — the largest swing across the quantitative energy series this week ([[energy-prices]])
...
- **The slow-moving record:** atmospheric CO2 stands at 429.97 ppm (Mauna Loa, 2.85 ppm/yr) — not a weekly 'shift' but the baseline every energy story is told against; the demonstrator flags it as a different time-scale, not the week's headline ([[co2-monitoring]])
...
- **Commodity spine — crude oil ties three feeds together:** the physical balance (-3,168 EIA stocks, 2026-07-03); the spot price (WTI $70.48/bbl); the pump (downstream fuel-price panel). One commodity, traced from the ground to the pump across separate L1 feeds ([[crude-oil-inventories]], [[energy-prices]], [[fuel-prices]])
...
- **California** surfaces under 2 channels this week (Climate signals + environmental-hazards) — a co-occurrence in the open data, reported as a link, not a cause ([[climate-anomalies]], [[co2-monitoring]], [[natural-events]], [[radiation-observations]], [[sea-ice-extent]], [[thermal-escalations]], [[wildfire-detections]])
- **Portugal** surfaces under 2 channels this week (Energy supply + environmental-hazards) — a co-occurrence in the open data, reported as a link, not a cause ([[crude-oil-inventories]], [[energy-prices]], [[fuel-prices]], [[natural-events]], [[natural-gas-storage-eu]], [[radiation-observations]], [[thermal-escalations]], [[wildfire-detections]])
...
- 2026-07-10 — regenerated TOP5 demonstrator answers from the 2026-07-10 live bundle (2026-W28); 5 cross-channel answers, every claim L1-sourced.
