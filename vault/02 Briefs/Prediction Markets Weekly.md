...
> source, and takes no position on the underlying question. (This cycle absorbs the 2026-07-31 and
> 2026-08-01 ingest: a ninth listing rotation — the Fed-rate-cut question is replaced by a Polymarket
> contract titled "Will the U.S. invade Iran before 2027?", quoted at a 0.245 yes price on ~$51.53M
> volume as of the 08-01 pull — a geopolitical question after a monetary-policy one; the new listing
> first appeared on the 07-31 pull and its book grew ~$0.6M into 08-01.)

## This week at a glance

- The WorldMonitor prediction-market feed continued to list a single live market, and the
  listing **rotated** again this cycle — a **ninth rotation**: the 2026-07-31 and 2026-08-01 pulls
  carry Polymarket's **"Will the U.S. invade Iran before 2027?"**, quoted at a **0.245 yes
  price** — the venue's implied **24.5% probability** ([[prediction-markets]]).
- This is the **ninth listing rotation** in the brief's run (Greenland → Russia → Israel →
  US–Iran uranium → Iran–MOU → Iran-regime → Base-token → Fed-rate-cuts → US-invade-Iran): the "Will
  no Fed rate cuts happen in 2026?" market that the 07-30 pull carried (~$45.64M book) no longer
  appears, and the feed swings from a US monetary-policy question back to a **geopolitical** one. The
  feed does not state how many markets sit behind its single rotating slot, so azimuth records
  presence and absence as the observed facts and carries no view on which markets it may or may not
  surface next ([[prediction-markets]]).
- Cumulative traded volume on the new listing is recorded at **$51,530,245** on the 08-01 pull
  (from **$50,904,761** on its 07-31 debut, a ~$0.6M one-day increment) — the **deepest book
  recorded** in the brief's run, above the outgoing Fed-rate listing's ~$45.64M. Because the
  question changed, the price and volume are **not week-on-week comparable** with the prior listing.
  Volume is reported as a measure of liquidity behind the quoted odds, not as a signal to act on
  ([[prediction-markets]]).

## The market

- Polymarket's quoted **yes price of 0.245** is the observed datum: traders are collectively
  paying about 25 cents for a contract that pays out 1.00 if the market's stated condition — a US
  invasion of Iran before 2027 — resolves true, which by construction reads as a **24.5% implied
  probability** priced by the venue. The question is a geopolitical one; azimuth's report is not a
  call on it: it records the venue's number and takes no position on the outcome or the market's
  resolution ([[prediction-markets]]).
- The **$51,530,245 cumulative traded volume** recorded on the 08-01 pull is the liquidity behind
  that price — the deepest book the brief has recorded, above the outgoing Fed-rate listing's
  ~$45.64M, and because the question itself changed the two are not directly comparable. Volume is
  reported as a measure of how much weight sits behind the quoted odds, not as a signal to act on
  ([[prediction-markets]]).

## Reading the week

- A ninth listing rotation, a new question, the deepest book yet. The feed's single live contract
  now carries Polymarket's "Will the U.S. invade Iran before 2027?", quoted at a **24.5%
  implied probability** on **$51,530,245** volume on the 08-01 pull — a geopolitical question
  after a monetary-policy one, so the number is not week-on-week comparable with the outgoing
  Fed-rate listing. azimuth states what was recorded and stops there: the odds are the market's,
...
- **Breadth note (honest scope):** the live feed still lists exactly one market at a time, and
  the listing has now rotated on **nine** synthesis cycles (Greenland → Russia → Israel → US–Iran
  uranium → Iran–MOU → Iran-regime → Base-token → Fed-rate-cuts → US-invade-Iran) — so week-on-week
  price continuity is not guaranteed across cycles, and this cycle's number rests on a different
  question than the last. As the upstream feed carries a broader market set, this note widens to
  report the spread of priced questions; until then it tracks whatever single market the feed
  quotes, reporting price, volume and listing changes as observed facts ([[prediction-markets]]).
