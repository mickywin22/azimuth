...
- The WorldMonitor prediction-market feed surfaced a single live market this cycle — Polymarket's
...
- Polymarket's quoted **yes price of 0.105** is the observed datum: traders are collectively
  paying 10.5 cents for a contract that pays out 1.00 if the US acquires part of Greenland in
...
- **Breadth note (honest scope):** the live feed currently lists exactly one market, so this
  brief is necessarily narrow. As the upstream feed carries a broader market set, this note
  widens to report the spread of priced questions; until then it tracks the one quoted market
  week-on-week, reporting price and volume moves as observed facts ([[prediction-markets]]).
