...
> date of current cycle: 2026-07-25.)
...
- The 8-event active set held unchanged through the 2026-07-25 pull: the Venezuela
  natural-disaster event (cf-1625 era) that exited on 2026-07-23 has not returned, and no new
  event entered — all 8 remain held entries from prior pulls ([[internet-outages]]).
